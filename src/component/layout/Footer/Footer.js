  ...
  return (
    <div className="Footer flex space__around pz__15" style={{"borderTop":".3px solid rgba(21,21,21,0.5)"}}>
      ...
      <div className="footer1st">
        <img
          src="https://uxwing.com/wp-content/themes/uxwing/download/19-e-commerce-currency-shopping/shopping-bag.svg"
        ...
        <div className="app">
            ...
            <Link to="/creator"><img src="https://www.nicepng.com/png/full/17-179971_itunes-logo-png.png" style={{"width":"150px","margin":"10px"}} /></Link>
            <Link to="/creator"><img src="https://e7.pngegg.com/pngimages/384/968/png-clipart-google-play-app-store-android-mobile-app-android-text-logo.png" style={{"width":"150px","margin":"10px"}} /></Link>
            </div>
        </div>
      </div>
      {/* Footer 2nd part */}
